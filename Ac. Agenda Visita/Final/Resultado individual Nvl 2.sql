...
visita_agenda,
agenda,
case when agenda <> 0 then
round((visita_agenda/agenda)*100,0) else 0 end perc,
(case when agenda <> 0 then
...
AND CDREPRESENTANTE = 23-- not in (43,35,52,42, 54,58,62,59,55,10,2)
group by  
cdrepresentante, 
VEN.APELIDO, 
DTVISITA 
order by 
codigo, 
dtvisita) b on a.dt=b.dtvisita where codigo is not null order by b.codigo, b.dtvisita)