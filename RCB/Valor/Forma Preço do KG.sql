...
REALIZADO_PESO,
META,
CASE WHEN REALIZADO_VALOR>0 THEN
ROUND((REALIZADO_VALOR/REALIZADO_PESO),2) ELSE 0 END  AS VALOR_KG,
CASE WHEN REALIZADO_VALOR>0 THEN
ROUND((REALIZADO_VALOR/REALIZADO_PESO),2)*META ELSE 0 END META_VALOR--,
--case when meta = 0 or realizado = 0 then 0 else (((REALIZADO/META)-1)*100) end  AS PERCENTUAL,
--CASE WHEN META <> 0 AND REALIZADO <> 0 THEN
--CASE WHEN ((REALIZADO/META)-1)>=0 THEN 30 ELSE 0 END ELSE 0 END AS PREMIO
...
APELIDO AS VENDEDOR,
GRUPO,
NVL(SUM(VALOR),0) AS REALIZADO_VALOR,
NVL(SUM(ITEM),0) AS REALIZADO_PESO,
...
CASE WHEN PR.CODGRUPOPROD IN(1010101,1010102,1010103,1010104) THEN (SELECT DESCRGRUPOPROD FROM TGFGRU WHERE CODGRUPOPROD = 1010100)
     ...
     WHEN PR.CODGRUPOPROD IN(1010701,1010702,1010703,1010704) THEN (SELECT DESCRGRUPOPROD FROM TGFGRU WHERE CODGRUPOPROD = 1010700)
     ...
     WHEN PR.CODGRUPOPROD IN(1020401,1020402,1020403,1020404,1020405) THEN (SELECT DESCRGRUPOPROD FROM TGFGRU WHERE CODGRUPOPROD = 1020400)
...
NVL(
CASE WHEN PR.CODGRUPOPROD IN(1010101,1010102,1010103,1010104) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010301,1010302,1010303,1010304) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010401,1010402,1010403,1010404) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010501,1010502,1010503,1010504) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010601,1010602,1010603,1010604) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010701,1010702,1010703,1010704) AND CAB.CODVEND IN(17,20,10,14) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010801,1010802,1010803,1010804) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1010901.1010902,1010903,1010904) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1011001,1011002,1011003,1011004) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1011101,1011102,1011103,1011104) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1011201,1011202,1011203        ) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020101,1020102,1020103,1020104) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020201,1020202,1020203,1020204) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020301,1020302,1020303,1020304) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020401,1020402,1020403,1020404,1020405) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020501,1020502,1020503,1020504) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020601,1020602,1020603,1020604) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020701,1020702,1020703,1020704) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
     WHEN PR.CODGRUPOPROD IN(1020801,1020802,1020803,1020804) THEN NVL(SUM((((ITE.QTDNEG * ITE.VLRUNIT) + ITE.VLRIPI + ITE.VLRSUBST - ITE.VLRDESC - ITE.VLRREPRED) )),0)
END,0) AS VALOR,
NVL(
CASE WHEN PR.CODGRUPOPROD IN(1010101,1010102,1010103,1010104) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010301,1010302,1010303,1010304) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010401,1010402,1010403,1010404) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010501,1010502,1010503,1010504) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010601,1010602,1010603,1010604) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010701,1010702,1010703,1010704) AND CAB.CODVEND IN(17,20,10,14) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010801,1010802,1010803,1010804) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1010901.1010902,1010903,1010904) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1011001,1011002,1011003,1011004) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1011101,1011102,1011103,1011104) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1011201,1011202,1011203        ) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020101,1020102,1020103,1020104) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020201,1020202,1020203,1020204) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020301,1020302,1020303,1020304) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020401,1020402,1020403,1020404,1020405) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020501,1020502,1020503,1020504) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020601,1020602,1020603,1020604) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020701,1020702,1020703,1020704) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
     WHEN PR.CODGRUPOPROD IN(1020801,1020802,1020803,1020804) THEN NVL(SUM(PR.PESOLIQ*ITE.QTDNEG),0)
END,0) AS ITEM
...
AND CAB.CODEMP = 1
AND CAB.CODVEND = 3--(SELECT USU.CODVEND FROM TSIUSU USU WHERE USU.CODUSU = STP_GET_CODUSULOGADO())

AND TRUNC(CAB.DTFATUR) BETWEEN TO_DATE('01/02/2019','DD/MM/YYYY') AND TO_DATE('13/06/2019','DD/MM/YYYY') 
GROUP BY  CAB.CODVEND, VEN.APELIDO, PR.CODGRUPOPROD) b

full OUTER join

(select ven.codvend, ven.apelido, gpr.grupo from(

select DESCRgrupoprod as grupo
from tgfgru
where codgrupoprod
...
)gpr, tgfven ven where ven.CODEMP = 1 and VEN.CODVEND =  3 --(SELECT USU.CODVEND FROM TSIUSU USU WHERE USU.CODUSU = STP_GET_CODUSULOGADO())
